...
const SUBTITLES_OUTLINE_SIZES = [0, 1, 2, 3, 4, 5, 6];
const SUBTITLES_BACKGROUND_OPACITIES = [0, 0.25, 0.5, 0.75, 1];
...
module.exports = {
    ...
    SUBTITLES_SIZES,
    SUBTITLES_FONTS,
    SUBTITLES_OUTLINE_SIZES,
    SUBTITLES_BACKGROUND_OPACITIES,
    SEEK_TIME_DURATIONS,
